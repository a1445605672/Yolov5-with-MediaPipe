...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        print('-------------------------------------')
        x_min=dataset.bbox[0] -50
        x_max=dataset.bbox[0] + dataset.bbox[2]
        y_min=dataset.bbox[1] - 100
        y_max=dataset.bbox[1] + dataset.bbox[3] + 50
        print('bounding box is', dataset.bbox[0] - 50, dataset.bbox[1] - 100, dataset.bbox[0] + dataset.bbox[2] + 50, dataset.bbox[1] + dataset.bbox[3] + 50)
        print('--------------------------')
        # 1,2,3,4 分别对应左上，右上，右下，左下四个点
        hl1 = y_max / 430  # 监测区域高度距离图片顶部比例
        wl1 = (560-x_min) / 560  # 监测区域高度距离图片左部比例
        hl2 = y_max / 430  # 监测区域高度距离图片顶部比例
        wl2 = (560-x_max) / 560  # 监测区域高度距离图片左部比例
        hl3 = y_min / 430  # 监测区域高度距离图片顶部比例
        wl3 = (560-x_max) / 560  # 监测区域高度距离图片左部比例
        hl4 = y_min / 430  # 监测区域高度距离图片顶部比例
        wl4 = (560-x_min) / 560  # 监测区域高度距离图片左部比例

        # hl1 = y_max / 720  # 监测区域高度距离图片顶部比例
        # wl1 = x_min / 1280 # 监测区域高度距离图片左部比例
        # hl2 = y_max / 720  # 监测区域高度距离图片顶部比例
        # wl2 = x_max / 1280  # 监测区域高度距离图片左部比例
        # hl3 = y_min / 720  # 监测区域高度距离图片顶部比例
        # wl3 = x_max / 1280  # 监测区域高度距离图片左部比例
        # hl4 = y_min / 720  # 监测区域高度距离图片顶部比例
        # wl4 = x_min / 1280  # 监测区域高度距离图片左部比例
